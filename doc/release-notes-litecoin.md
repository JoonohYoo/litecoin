Marvelcoin Core version *0.15.1* is now available from:

  <https://download.marvelcoin.org/marvelcoin-0.15.1/>
...
A number of changes to the way Marvelcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 tanos per kB (0.00001 MVC). This is to prepare for dropping the minimum transaction fee to 0.1 tanos per kB (0.0001 MVC) in the next release.
