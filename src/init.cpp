...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/marvelcoin-project/marvelcoin>";
    const std::string URL_WEBSITE = "<https://marvelcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Marvelcoin version %s\n", FormatFullVersion());
}
