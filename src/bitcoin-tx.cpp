...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s marvelcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  marvelcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded marvelcoin transaction") + "\n" +
              "  marvelcoin-tx [options] -create [commands]   " + _("Create hex-encoded marvelcoin transaction") + "\n" +
              "\n";
