...
#if defined(NDEBUG)
# error "Marvelcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Marvelcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s MVC additional fees, %d delta bytes\n",
